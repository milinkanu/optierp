...
@app.post('/onboarding/api-prefill', response_model=APIOnboardingResponse)
...
@app.post('/onboarding/ocr-upload', response_model=OCRUploadResponse)
...
@app.get('/onboarding/job/{job_id}', response_model=OnboardingJobStatus)
...
@app.post('/onboarding/confirm', response_model=OnboardingConfirmationResponse)
